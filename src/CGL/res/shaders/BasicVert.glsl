...
void main()
{
   ...
   It then uses the window params from glViewPort to map NDCs to screen coordinates in pixels e.g. between 0 and 800 (this process is called t he viewport transform)
